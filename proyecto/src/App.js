...
function App() {
  ...
  const handleLogout = () => {
    ...
    // navigate('/login'); // Si usas useNavigate hook, pero aquí estamos en App.js
  };
  ...
  return (
    <Router>
      ...
      <NotificationProvider>
        ...
        <Routes>
          {/* Rutas públicas */}
          {/* Pasamos handleLogout a Login para que pueda cerrar sesión si es necesario (ej. token inválido) */}
