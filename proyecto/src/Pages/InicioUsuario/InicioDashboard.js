  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          <strong>Consejo:</strong> Para aprovechar al máximo tu experiencia, te recomendamos verificar y completar la información de tus compañeros peludos en la sección "Mis Mascotas".
        </p>
      </motion.div>
    </motion.div>
  );
